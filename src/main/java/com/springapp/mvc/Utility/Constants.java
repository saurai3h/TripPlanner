...
public class Constants {
    ...
    public static final  double MAX_AVG_TRAVEL_TIME_PER_DAY = 12.5;
    public static final  double MIN_AVG_TRAVEL_TIME_PER_DAY = 5.5;
    public static final double MAX_DAY_LENGTH_ABSOLUTE = 14;
    public static final double MIN_DAY_LENGTH_ABSOLUTE = 3;
